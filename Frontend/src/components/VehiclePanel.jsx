...
const VehiclePanel = ({vehiclePanel, setVehiclePanel, setConfirmRidePanel}) => {
  ...
  return (
    <div ref={vehiclePanelRef} className="fixed w-full z-10 bottom-0 bg-white p-5 translate-y-full">
      ...
      <div onClick={()=> {
      ...
      }} className="flex items-center justify-between w-full mt-2 p-2 border-black border-2">
        ...
        <div>
          <h4>UberGo <span><FaUser className="inline mr-2" />
            4</span></h4>
          <h5>2 mins away</h5>
      ...
      <div onClick={()=> {
        ...
        <img className="h-12" src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1649231091/assets/2c/7fa194-c954-49b2-9c6d-a3b8601370f5/original/Uber_Moto_Orange_312x208_pixels_Mobile.png" alt="Reach destination through" />
        <div>
          <h4>UberGo <span><FaUser className="inline mr-2" />
            4</span></h4>
          <h5>2 mins away</h5>
